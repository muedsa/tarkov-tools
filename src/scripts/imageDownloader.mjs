...
const foundInRaidBarterItemsFileData = fs.readFileSync(path.join(projectRootDir, 'public/tarkov/data/pve/foundInRaidBarterItems.json'), 'utf-8');
...
const foundInRaidTaskItemsFileData = fs.readFileSync(path.join(projectRootDir, 'public/tarkov/data/pve/foundInRaidTaskItems.json'), 'utf-8');
